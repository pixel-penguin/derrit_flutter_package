...
class SunmiFlutterPrint {
  static const MethodChannel _channel =
      const MethodChannel('sunmi_flutter_print');
  ...
  static Future<Null> setAlignment({TEXTALIGN align}) async {
    ...
    args.putIfAbsent(
        ...
        () => align == TEXTALIGN.LEFT
            ? 0
            : align == TEXTALIGN.CENTER ? 1 : align == TEXTALIGN.RIGHT ? 2 : 0);
        ...
        () => errorLevel == ERRORLEVEL.L
            ...
            : errorLevel == ERRORLEVEL.M
                ...
                : errorLevel == ERRORLEVEL.Q
                    ? 2
                    : errorLevel == ERRORLEVEL.H ? 3 : 0);

    await _channel.invokeMethod("printQRCode", args);
  }

  static Future<Null> printBarcode(String text, int height, int width,
      {SYMBOLOGY symbology, TEXTPOS textPosition}) async {
    Map<String, dynamic> args = <String, dynamic>{};
